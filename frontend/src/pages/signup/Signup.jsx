  ...
  return (
    <div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
      <div className="w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-0">
        <h1 className="text-3xl font-semibold text-center text-blue-300">SignUp <span className='text-blue-500'>ChatApp</span></h1>

        <form>
            <div>
                <label className='label p-2'>
                    <span className='text-gray-200 text-base label-text'>Full Name</span>
                </label>
            ...
            <div>
                <label className='label p-2'>
                    <span className='text-gray-200 text-base label-text'>Confirm Password</span>
                </label>
            ...
            <a href="#" className='text-white text-sm hover:underline hover:text-blue-900 mt-2 inline-block'>
